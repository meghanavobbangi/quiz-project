...
int main()
     ...
     mainhome:
     system("cls");
     printf("\t\t\tMEGHANAS C PROGRAM QUIZ GAME\n");
    ...
    system("cls");
    printf("\n ------------------  Welcome %s to MEGHANAS C Program Quiz Game --------------------------",playername);
    ...
    printf("\n    total of 10 questions. Each right answer will be awarded $10,000!");
...
game:
     ...
     switch(r)
		...
		if (toupper(getch())=='C')
			{printf("\n\nCorrect!!!");countr++;getch();
			 break;getch();}
		       ...
		       {printf("\n\nWrong!!! The correct answer is C.5");getch();
		       goto score;
		       break;}
        ...
        case 3:
		printf("\n\n\nThe world longest straight road without any corners is located in ? ");
		printf("\n\nA.USA\t\tB.Austrila\n\nC.Saudi Arabia\t\tD.China"); 
		if (toupper(getch())=='C')
			{printf("\n\nCorrect!!!");countr++;getch();
			 break;}
		else
		       {printf("\n\nWrong!!! The correct answer is C.Saudi Arabia");getch();
		       goto score;
		       break;}
		...
		if (toupper(getch())=='D')
			...
			break;}
		       ...
		       {printf("\n\nWrong!!! The correct answer is D.Finland");getch();goto score;
		       break;}
...
void help()
	...
	printf("\n\n\t*********************BEST OF LUCK*********************************");
	printf("\n\n\t*****MEGHANAS C PROGRAM QUIZ GAME is developed by CODE WITH C TEAM********");}
